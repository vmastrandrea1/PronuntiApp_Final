 ...
 * Use the {@link Prenotazioni_Logopedista#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Prenotazioni_Logopedista extends Fragment {
    ...
    private MyAdapter_Prenotazioni myAdapter;
    private ArrayList<String> list;
    private ViewGroup container;


    public Prenotazioni_Logopedista() {
        // Required empty public constructor
    }

    public static Prenotazioni_Logopedista newInstance(String sessionKey) {
        Prenotazioni_Logopedista fragment = new Prenotazioni_Logopedista();
    ...
    public void onResume() {
        ...
        add_reservation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getParentFragmentManager()
                        .beginTransaction()
                        .replace(container.getId() , RegistraPrenotazioni.newInstance(sessionKey))
                        .commit();
            }
        });
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list = new ArrayList<>();
        myAdapter = new MyAdapter_Prenotazioni(view.getContext(),list,sessionKey,getParentFragmentManager(),container);
