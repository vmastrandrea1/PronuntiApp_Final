            ...
            public void onClick(View v) {
                if(audio_registrato != null){
                   ...
                   // Dialog esercizio eseguito
                    ...
                    textViewMonete.setText(esercizio1.getMonete() + getString(R.string.monete));
                    textViewEsperienza.setText(esercizio1.getEsperienza() + getString(R.string.punti_esperienza));
