...
public class MyAdapter_Appuntamenti_Genitore extends RecyclerView.Adapter<MyAdapter_Appuntamenti_Genitore.MyViewHolder> {
    ...
    public MyAdapter_Appuntamenti_Genitore(Context context, ArrayList<String> list, String sessionKey,
